...
public class MyString {
    public static void main(String args[]) {
        ...
        System.err.println(countChar(name, 'r'));
        System.out.println(randomStringOfLetters(4));
        System.out.println(subsetOf(name, "csttt"));
    ...
    public static String randomStringOfLetters(int n) {
        String alphabet = "abcdefghijklmnopqrstuvwxyz"; // All lowercase letters
        String result = ""; // Resulting string

        for (int i = 0; i < n; i++) {
            int randomIndex = (int) (Math.random() * 26); // Generate a random index between 0 and 25
            result += alphabet.charAt(randomIndex); // Append the random character to the result
        }
    ...
    public static String remove(String str1, String str2) {
        //// Replace the following statement with your code
            ...
            for(int i = 0 ; i < str2.length() ; i ++) {
             checking = str1.indexOf(str2.charAt(i));
                str1 = str1.substring(0, checking) + str1.substring(checking + 1, str1.length());
            }
            return str1;
        }
